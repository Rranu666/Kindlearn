...
import { FLASHCARD_DECK } from '@/lib/flashcards';
import Navbar from '@/components/landing/Navbar';
import { Button } from '@/components/ui/button';
import { ArrowLeft, Ear } from 'lucide-react';
import { useSpeech } from '@/hooks/useSpeech';
import ListenQuestion from '@/components/listen/ListenQuestion';
import ListenSummary from '@/components/listen/ListenSummary';
      ...
      <div className="pt-20 pb-16 px-4 md:px-6">
        <div className="container mx-auto max-w-xl">
          ...
          <div className="flex items-center gap-3 mb-6">
            <Button variant="ghost" size="icon" onClick={() => navigate(`/dashboard?lang=${langId}`)}>
          ...
          <AnimatePresence mode="wait">
            {done ? (
              <ListenSummary
                ...
                onDashboard={() => navigate(`/dashboard?lang=${langId}`)}
              />
            ) : currentWord ? (
              <ListenQuestion
                key={`q-${qIndex}`}
