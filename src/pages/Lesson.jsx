...
import { LANGUAGES, DAILY_TOPICS } from '@/lib/languages';
import { useSpeech } from '@/hooks/useSpeech';
import { buildWordListWithReviews, recordMiss, recordHit } from '@/lib/struggledWords';
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="border-b bg-card/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto max-w-2xl px-4 py-3 flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => navigate(`/dashboard?lang=${langId}`)} aria-label="Exit lesson">
            <X className="w-5 h-5" />
          </Button>
