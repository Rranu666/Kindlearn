...
export default function Dashboard() {
  ...
  const handleStartLesson = (day) => {
    navigate(`/lesson?lang=${langId}&day=${day}&pid=${progress?.id}`);
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="pt-20 pb-16 px-4 md:px-6">
        <div className="container mx-auto max-w-5xl">
          <Button variant="ghost" onClick={() => navigate('/select-language')} className="mb-4 -ml-2">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
              ...
              <div className="flex gap-2 flex-wrap w-full md:w-auto">
                <Button
                  ...
                  onClick={() => navigate(`/vocabulary?lang=${langId}`)}
                >
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-12 px-4 rounded-2xl font-semibold hidden sm:inline-flex"
                  onClick={() => navigate(`/flashcards?lang=${langId}`)}
                >
                ...
                <Button
                  ...
                  onClick={() => navigate(`/listen?lang=${langId}`)}
                >
                ...
                {(p.struggled_words && Object.keys(p.struggled_words).length > 0) && (
                  <Button
                    ...
                    onClick={() => navigate(`/review?lang=${langId}`)}
                  >
                ...
                <Button
                  ...
                  variant="outline"
                  className="h-12 px-4 rounded-2xl font-semibold hidden sm:inline-flex"
                  onClick={() => navigate(`/insights?lang=${langId}`)}
                >
