...
import { buildVocabularyFromLessons, initializeVocabularySRS, getVocabularyDueForReview, updateVocabularyProgress, getVocabularyStats } from '@/lib/vocabularyEngine';
      ...
      <div className="border-b bg-card/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="container mx-auto max-w-6xl px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button variant="ghost" size="icon" onClick={() => navigate(`/dashboard?lang=${langId}`)} aria-label="Back to dashboard">
