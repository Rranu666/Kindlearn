    ...
    <nav className="bg-gradient-to-r from-violet-500 via-pink-500 to-amber-400 p-1">
      <div className="bg-white/90 backdrop-blur-sm">
        <div className="container mx-auto px-4 h-14 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2 text-violet-700">
          ...
          <Link to="/parent-settings" className="flex items-center gap-1.5 text-violet-600 hover:text-violet-800 transition-colors">
