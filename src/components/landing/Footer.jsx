        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link to="/select-language" className="hover:text-foreground transition-colors">30-Day Challenge</Link></li>
              <li><Link to="/kids" className="hover:text-foreground transition-colors">Kids Zone</Link></li>
              <li><Link to="/help" className="hover:text-foreground transition-colors">Help</Link></li>
              <li><Link to="/select-language" className="hover:text-foreground transition-colors">Get Started</Link></li>
            </ul>
          </div>
